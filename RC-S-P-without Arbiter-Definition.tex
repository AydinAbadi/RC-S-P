...
\section{Definition of Recurring Contingent Service Payment Without Arbiter}\label{sec::RC-S-P-Definition2}
...
\Big(
F(u^{\scriptscriptstyle *},\bm{q}_{\scriptscriptstyle j}, {pp})\neq h_{\scriptscriptstyle j} \ \wedge\\ (d_{\scriptscriptstyle j}=1	\vee y_{\scriptscriptstyle \mathcal{S},j}=0 \ \vee \   \\ \textcolor{purple}{coin_{\scriptscriptstyle\mathcal{C},j}\neq \frac{coin_{\scriptscriptstyle\mathcal C}^{\scriptscriptstyle*}}{z}+l} ) \Big)\\
\end{array} \middle |
    \begin{array}{l}
...
$$ \Pr\left[
 ...
 \Big((M(u^{\scriptscriptstyle *},k, {pp})= \sigma  \wedge\\ Q(\text{aux},k, {pp})= \bm{q}_{\scriptscriptstyle j})\ \wedge\\
  ...
  (b_{\scriptscriptstyle j}=1 \ \vee \ y_{\scriptscriptstyle\mathcal{C},j}=0 \ \vee \\ \textcolor{purple}{coin_{\scriptscriptstyle\mathcal{S},j}\neq \frac {coin_{\scriptscriptstyle\mathcal S}^{\scriptscriptstyle*}}{z}+o + l}) 
  \Big)
 \\
