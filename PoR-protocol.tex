...
\item If $|\bm{\pi}|=|\bm{q}|=1$, then set $\beta=1$. Note, this step is taken only in the case where single proof and query is provided to a third-party verifier (e.g. in the case of proof of misbehaviour). 
